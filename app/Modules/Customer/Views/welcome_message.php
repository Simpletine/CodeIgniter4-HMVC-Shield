...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="/customer">Customer</a></li>
...
<section>
    ...
    <h1>About Customer page</h1>

    <p>The page you are looking at is being generated by command.</p>
    <pre><code>php spark module:create Customer</code></pre>

    <p>If you would like to edit this page you will find it located at:</p>

    <pre><code>app/Modules/Customer/Views/welcome_message.php</code></pre>

    <p>The corresponding controller for this page can be found at:</p>

    <pre><code>app/Modules/Customer/Controllers/Index.php</code></pre>
